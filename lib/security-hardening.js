...
const installAudit = (app) => {
  ...
  const auditSchemaReady = runExec(`CREATE TABLE IF NOT EXISTS audit_events (id TEXT PRIMARY KEY,user_id TEXT,role TEXT,action TEXT NOT NULL,method TEXT,path TEXT,status_code INTEGER,ip TEXT,user_agent TEXT,tab_id TEXT,metadata TEXT,created_at TEXT)`).catch(e => { console.error('[audit] schema:', e.message); throw e; });
